  ...
  return (
    <div className="gap-5 flex flex-col sm:flex-row">
      ...
      <Card
        ...
        role="Co Founder & CTO"
        backItems={[
          "MBA in Business Strategy, XYZ University",
          "Former CEO of TechWave Solutions (2018–2023)",
          "Led multiple AI and SaaS ventures with a global customer base",
          "Vision to build AI platforms that solve real-world problems across industries",
          "Strong background in entrepreneurship, SaaS platforms, and AI product design",
        ]}
      />
    </div>
  );
